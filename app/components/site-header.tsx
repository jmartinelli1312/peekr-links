      ...
      <header className="peekr-header">
        <div className="peekr-header-inner">
          ...
          <nav className="peekr-nav-desktop">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{display:"inline",verticalAlign:"middle",marginRight:5,marginTop:-2}}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>{t.explore}
            </Link>
            <Link
            ...
            >
              ...
              <div className="peekr-mobile-panel">
                <Link
                  ...
                  onClick={closeAllMenus}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{display:"inline",verticalAlign:"middle",marginRight:6,marginTop:-2}}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>{t.explore}
                </Link>
                <Link
                  href={localizedHref("/lists")}
                  className="peekr-mobile-item"
